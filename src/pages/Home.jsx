...
const Home = () => {
    ...
    return (
        <section className={`${theme ? "text-black" : "text-white"}`}>
            <div className="container flex lg:flex-row flex-col pt-[100px] pb-[30px] lg:py-0  h-screen  gap-2 md:justify-between my-auto  items-center font-poppins">
